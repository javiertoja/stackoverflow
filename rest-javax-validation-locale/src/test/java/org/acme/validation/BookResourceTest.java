...
public class BookResourceTest {
    ...
    @Test
    public void testBookWithoutAuthorES() {
        given()
                .body("{\"title\": \"catchy\", \"pages\":5}")
                .header("Content-Type", "application/json")
                .header("Application-Language", "es-ES, fr;q=0.9, es;q=0.8, de;q=0.7, *;q=0.5")
                .when()
                .post("/books/manual-validation")
                .then()
                .statusCode(200)
                .body("success", is(false), "message", containsString("autor"));
    }


    @Test
    public void testBookWithoutAuthorEn() {
        given()
                .body("{\"title\": \"catchy\", \"pages\":5}")
                .header("Content-Type", "application/json")
                .header("Application-Language", "en-US, fr;q=0.9, es;q=0.8, de;q=0.7, *;q=0.5")
                .when()
                .post("/books/manual-validation")
                .then()
                .statusCode(200)
